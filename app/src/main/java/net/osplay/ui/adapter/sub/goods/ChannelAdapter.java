...
public class ChannelAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //根据位置得到对应的数据
        Glide.with(mContext).load(Constants.BASE_URl_IMAGE+datas.get(position).getImage()).into(viewHolder.iv_icon);
        viewHolder.tv_title.setText(datas.get(position).getChannel_name());
        return convertView;
    }
