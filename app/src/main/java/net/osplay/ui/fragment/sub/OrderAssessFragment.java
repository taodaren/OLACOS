...
public class OrderAssessFragment extends BaseFragment {
    ...
    public OrderAssessFragment() {
    }

    @SuppressLint("ValidFragment")
    public OrderAssessFragment(Context mContext, int resId) {
        super(mContext, resId);
    }

    @Override
    public View initView() {
        View inflate = View.inflate(getContext(), R.layout.fragment_order_assess, null);
        mTabLayout = (TabLayout) inflate.findViewById(R.id.tab_layout_order_assess);
        mViewPager = (ViewPager) inflate.findViewById(R.id.vp_order_assess);
