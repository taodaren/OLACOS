...
public class OtherPostsFragment extends Fragment {
    ...
    @BindView(R.id.other_posts_recycler)
    RecyclerView otherPostsRecycler;
    Unbinder unbinder;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        inflate = inflater.inflate(R.layout.fragment_other_posts, container, false);
        unbinder = ButterKnife.bind(this, inflate);
        otherPostsRecycler.setLayoutManager(new LinearLayoutManager(getContext()));
    ...
    private void formatOposts(String json) {
        ...
        otherPostsRecycler.setAdapter(new MyPostsAdapter(getContext(),rows));
    }
