...
public class TopicInfoFineFragment extends BaseFragment implements OnRefreshListener, OnLoadMoreListener {
    private static final String TAG = "TopicInfoFineFragment";
    private static final int ACTION_REFRESH = 0;
    private static final int ACTION_LOAD_MORE = 1;
    private static final int DATA_COUNT = 10;
    @BindView(R.id.swipe_target)
    RecyclerView swipeTarget;
    @BindView(R.id.swipe_fm_topic_info_fine)
    ...
    public View initView() {
        return View.inflate(getContext(), R.layout.fragment_topic_info_fine, null);
    }
