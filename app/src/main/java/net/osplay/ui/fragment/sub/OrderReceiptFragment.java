...
public class OrderReceiptFragment extends BaseFragment {
    ...
    public View initView() {
        View inflate = View.inflate(getContext(), R.layout.fragment_order_receipt, null);
        mTabLayout = (TabLayout) inflate.findViewById(R.id.tab_layout_order_receipt);
        mViewPager = (ViewPager) inflate.findViewById(R.id.vp_order_receipt);
